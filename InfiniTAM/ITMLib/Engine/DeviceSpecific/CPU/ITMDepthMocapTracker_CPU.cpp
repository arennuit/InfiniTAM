...
ITMDepthMocapTracker_CPU::ITMDepthMocapTracker_CPU( Vector2i imgSize,
    ...
    ITMDepthMocapTracker(imgSize, trackingRegime, noHierarchyLevels,
    noICPRunTillLevel,
    distThresh,
...
ITMDepthMocapTracker_CPU::~ITMDepthMocapTracker_CPU(void)
{

}

int ITMDepthMocapTracker_CPU::ComputeGandH(float &f, float *nabla, float *hessian, Matrix4f approxInvPose)
{
